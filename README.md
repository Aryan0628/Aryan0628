...
I'm a **2nd-year ECE student at MNNIT Allahabad**, building production-grade systems at the intersection of **distributed systems**, **AI/ML**, and **web & full-stack engineering**. I architect and ship real products — from **web platforms** and **multi-agent orchestration pipelines** to **high-performance mobile apps** and **cloud deployments**.

I care about writing code that is technically rigorous, solves real problems, and scales.

- 🏆 &nbsp; **2nd Winner** Sankalp 2026 National Hackathon &nbsp;|&nbsp; **1st Runner-up** GDG Hackathon TechSprint'26 &nbsp;|&nbsp; **Winner** Quantacon – WebSprint'26 &nbsp;|&nbsp; **2nd Runner-up** Innodev MNNIT
- ☁️ &nbsp; **Technical Member** at AWS Cloud Club, MNNIT Allahabad
- 🤝 &nbsp; **Open to** internship and collaboration in distributed systems, AI infrastructure, and full-stack engineering
